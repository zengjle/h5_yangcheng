...
module.exports = {
    ...
    "question"           : {                                     // 题目信息
        "answer" : [ 1, 2, 1, 1, 2, 1, 1, 2, 2, 2, 2, 1, 2, 2, 2, 2, 1, 2 ],        // 答案
        "info"   : {
            "1"  : {
            ...
            "10" : {
                "subject" : "针对电动车交通违法乱象指的是哪些违法乱象?",
                "option"  : [ "按道行驶,佩戴安全帽,等待红绿灯", "闯红灯,逆向行驶" ]
            },
            "11" : {
                "subject" : "骑电动自行车闯红灯罚款多少钱?",
                "option"  : [ "20元", "50元" ]
            },
            "12" : {
                "subject" : "小橙车的生日是哪一天?",
            ...
            "13" : {
                "subject" : "橙车出行总部位于哪里?",
                "option"  : [ "大学路西洋学生公寓", "大通北路46号" ]
            },
            "14" : {
                "subject" : "橙车出行押金交了能及时退吗?",
                "option"  : [ "能,1-7工作日", "能,1-3工作日" ]
            },
            "15" : {
                "subject" : "橙车出行的24小时服务热线是多少?",
                "option"  : [ "114", "0596-2671066" ]
            },
            "16" : {
                "subject" : "小橙车可以骑行至动车站吗?",
                "option"  : [ "可以", "不可以(扣除50积分)" ]
            },
            "17" : {
                "subject" : "小橙车积分可以参与抽奖吗?",
                "option"  : [ "可以", "不可以" ]
            },
            "18" : {
                "subject" : "鲤鱼跃龙门第一名可以获得什么?",
                "option"  : [ "鱼", "橙车大礼包" ]
            },
        }
    },
    ...
    "introduced" : {
        "0" : {
            "label" : "通过完成每日任务，领取每日奖励，饭点前往古城领取食物，偷取好友食物，等方法来喂养你的锦鲤获取福缘获得丰厚奖励。喂养鲤鱼达第一阶，奖橙车vlp一个月，第二阶奖vlP三个月，第三阶并第一名奖价值1200元的橙车免费骑行券!",
        },
        "1" : {
        ...
        "3" :{
            "label" :  "每周可以祈福一次,祈福有概率获得大食袋或者小食袋;每周可以掷珓来获得大量的橙车积分,当出现圣杯时可以继续掷珓哦!(最多3次)"
        }
    }
};